...
async function search() {
    ...
    response = await postRequestJson('http://localhost:8080/okved/search_category', obj)
    if (response.ok) { 
...
async function searchComp() {
    ...
    response = await postRequestJson('http://localhost:8080/okved/search_company', data) 
